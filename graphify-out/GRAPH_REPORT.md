...
Cohesion: 0.02
Nodes (84): _build_style(), _build_window_text(), calculate_margin_v(), _collect_valid_words(), _emit_window_events(), _escape_ass_text(), generate_ass_subtitles(), _hex_to_ass_override() (+76 more)
