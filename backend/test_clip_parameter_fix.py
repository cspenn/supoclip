...
async def test_parameter_shadowing_fix():
    ...
    async with async_session() as db:
        try:
            ...
            print(f"✅ The 'clip_text' parameter is working correctly")
            print(f"✅ SQLAlchemy text() function is no longer shadowed")
            ...
            assert saved_text == "This is test clip text content", \
                f"Expected text not saved. Got: {saved_text}"

            print(f"✅ VERIFIED: Clip text was saved correctly to database")
