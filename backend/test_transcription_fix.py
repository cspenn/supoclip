...
if result["words"]:
    ...
    if first_word["start"] < first_word["end"]:
        print(f"✅ Word timing is valid: start < end")
    else:
        print(f"❌ Word timing is INVALID: start={first_word['start']}, end={first_word['end']}")
        success = False
...
if result["segments"]:
    ...
    if first_segment["start"] < first_segment["end"]:
        print(f"✅ Segment timing is valid: start < end")
    else:
        print(f"❌ Segment timing is INVALID: start={first_segment['start']}, end={first_segment['end']}")
        success = False
